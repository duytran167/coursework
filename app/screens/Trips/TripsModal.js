...
const TripsModal = ({ trip, isEdit, title, visible, onClose, onSubmit }) => {
    ...
    const onChangeInput = (text, value) => {
        ...
        if (value === "dateTrip") setDateTrip(text)
    }
            ...
            <Modal visible={visible} animationType="slide">
                <TouchableOpacity onPress={() => handleCloseModal()}>
                    <View style={styles.header}>
                        <RoundIcon antIconName={"close"} color={colors.INFO} style={{ backgroundColor: colors.LIGHT, padding: 0 }} />
                        <Text style={{
                            fontSize: 20,
                            color: colors.INFO,
                            paddingHorizontal: 5,
                ...
                <TouchableWithoutFeedback onPress={() => {
                    ...
                    <ScrollView contentContainerStyle={{ flexGrow: 1 }} style={styles.container}>
                        ...
                        <View style={styles.formContainer}>
                            ...
                            <TextInput value={dateTrip} onChangeText={(text) => onChangeInput(text, "dateTrip")} style={styles.textInput} />
